...
开源仓库是 [wanghui2323/ai-product-workbench](https://github.com/wanghui2323/ai-product-workbench)。本文对应 `v0.2.0`，源码中包含独立 skill、生成器、安装脚本和虚构文档助手示例；完整下载包见仓库的 [Releases](https://github.com/wanghui2323/ai-product-workbench/releases)。
